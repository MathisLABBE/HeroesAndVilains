...
export const useUserStore = defineStore('user', () => {
  ...
  const currentUser = ref<ConnectedUser | null>(null)
  ...
  async function loginUser(loginValue: string, passwordValue: string) {
  ...
  async function updateCurrentHero(hero: HeroPayload) {
    if (!isLogged.value) {
  ...
  function handleExpiredJwt(message: unknown) {
